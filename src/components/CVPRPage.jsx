                ...
                {cvprWorkshops.map((w, i) => (
                  ...
                  >
                    ...
                    <div className="flex flex-col gap-1 min-w-0 flex-1">
                      <p className="text-base font-semibold text-white leading-snug group-hover:text-gray-200 transition-colors">{w.name}</p>
                      <p className="text-xs text-gray-600">{w.venue}</p>
                    </div>
